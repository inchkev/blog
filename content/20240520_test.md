...
Text text text text text **bold text bold text bold text** text text... _italic text italic text italic text_... text text! Text text, ~~strikethrough text strikethrough text~~ **strong **with strong** in it** *emph *with emph* in it*
...
I'll want to make lists. Unordered ones. Lists are nice because sometimes you don't want to write fully-formed, coherent, sentences, but would much rather:
